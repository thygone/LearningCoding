...
class LinkedList:
    ...
    def remove(self, value):
        ...
        while current is not None:
            if current.data == value:## if the values match then remove it 
    ...
    def replace(self, old_value, new_value):
        ...
        itterate with loop like #3
        """
        new_node = self.head
        while new_node is not None:
            if new_node.data == old_value:
    ...
    def __reversed__(self):
        ...
        same as loop in 3 but backwards
        """
        new_node = self.tail
        while new_node is not None:
            yield new_node.data
