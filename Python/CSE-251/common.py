...
# List of all attributes to the class person
#   variables
#       id
#       name
#       parents []
...
class Family:
#______________________________________________________________
# List of all attributes to the class Family
#   variables
#       id
#       husband
#       wife
...
class Tree:
#______________________________________________________________
# List of all attributes to the class Tree
#   variables
#       people - 
#       families
#       start_family_id
...
#       does_family_exist
#       display
#       _test_number_connected_to_start(self):
#       count_generations
#_______________________________________________________________
